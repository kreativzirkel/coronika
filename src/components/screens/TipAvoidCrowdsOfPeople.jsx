...
const TipAvoidCrowdsOfPeople = ({ navigation, vw, getFontFamilyBold, getFontFamilyRegular, __ }) => {
...
export default memo(withI18n(withViewportUnits(TipAvoidCrowdsOfPeople)));
